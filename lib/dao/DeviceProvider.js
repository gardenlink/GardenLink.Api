  ...
  _logs = logs;
    ...
    if (config.MONGO.Habilitado == "true") {
      ...
      var DeviceSchema = new Schema({
           Id : { type: Number, index: { unique: true }, required : true }
		  , Nombre : String
		  , Tipo  : String
		  , Ip : String
		  , Puerto : Number
    ...
    if (config.NEDB.Habilitado == "true"){
      ...
      db.Device = new Datastore({ filename: config.NEDB.Path + 'Dispositivo.db', autoload:true});
...
method.SaveObject = function(obj, callback) {

  Save(obj.Id, obj.Nombre, obj.Tipo, obj.Ip, obj.Puerto, obj.Habilitado, obj.Estado, obj.FrecuenciaMuestreo, callback);

}

method.Save = function(Id, Nombre, Tipo, Ip,Puerto,Habilitado,Estado,FrecuenciaMuestreo, callback) {

  Save(Id, Nombre, Tipo, Ip,Puerto,Habilitado,Estado,FrecuenciaMuestreo, callback);

};

function Save(Id, Nombre, Tipo, Ip,Puerto,Habilitado,Estado,FrecuenciaMuestreo, callback) {
