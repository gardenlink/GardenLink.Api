	...
	_config =
	{
		    ...
		    "datasource" : {
		        ...
		        "MONGO" : { "Habilitado" : process.env.db_MONGO_Habilitado,
		                     ...
		                     "Puerto" : process.env.db_MONGO_Puerto,
		                     "BaseDatos" : process.env.db_MONGO_BaseDatos,
				...
				"sync" : {
				      "Habilitado" : process.env.sync_Habilitado,
				      "Intervalo" : process.env.sync_Intervalo,
							"Entidades" : {
								"Dispositivos" : process.env.sync_Entidades_Dispositivos,
								"Relays" : process.env.sync_Entidades_Relays,
								"Sensores" : process.env.sync_Entidades_Sensores,
								"Mediciones" : process.env.sync_Entidades_Mediciones
							},
							"Debug" : process.env.sync_Debug,
				      "TargetHost" : process.env.sync_TargetHost,
				      "TargetPort" : process.env.sync_TargetPort,
				      "BaseURL" : process.env.sync_BaseURL
				    },
		    ...
		    "monitor_datasource" : process.env.monitor_datasource,
				"temporizador_habilitado" : process.env.temporizador_habilitado,
		    "seguridad" : {
					"habilitado" : process.env.seguridad_jwt_habilitado,
		    	"jwt" : {
		    		"TOKEN_SECRET_JWT" : process.env.seguridad_jwt_token_secret_jwt
		    	}
		    }
	};
